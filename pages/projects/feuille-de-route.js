...
const RoadmapPage = () => {
  ...
  const currentPath = '/projects/feuille-de-route';
      ...
      <PageWrapper>
        ...
        <SectionContainer>
          <AnimateOnScreen>
            ...
            <StepCard>
              <div className="step-header">
                <span className="step-num">{t.p5Num}</span>
            ...
            <StepCard>
              <div className="step-header">
                <span className="step-num">{t.p6Num}</span>
            ...
            <StepCard>
              <div className="step-header">
                <span className="step-num">{t.p7Num}</span>
            ...
            <StepCard>
              <div className="step-header">
                <span className="step-num">{t.p8Num}</span>
                <h3 className="step-title">{t.p8Title}</h3>
              </div>
              <h4 className="step-subtitle">{t.p8Sub}</h4>
              <ul className="step-list">
                <li>{t.p8L[0]}</li>
                <li>{t.p8L[1]}</li>
                <li>{t.p8L[2]}</li>
        ...
        <SectionContainer>
          <AnimateOnScreen>
            <SectionHeader>
              <SectionTag>{t.pathTag}</SectionTag>
              <SectionHeading>{t.pathHeading}</SectionHeading>
            </SectionHeader>
